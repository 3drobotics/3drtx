...
#define TR_VFAILSAFE           "Mantieni\0 ""Personali\0""No impulsi"
...
#define TR_SYNCMENU            TR("Sinc.","Sinc.[Men\201]")
...
#define TR_DELETE_MODEL        TR("Canc. Modello","Cancella Modello") // TODO merged into DELETEMODEL?
